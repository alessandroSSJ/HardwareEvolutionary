...
%
%   X = GAMULTIOBJ(FITNESSFCN,NVARS,A,b,Aeq,beq,lb,ub,NONLCON,options) finds 
%   a Pareto set X with the default optimization parameters replaced by
...
%   $Revision: 1.1.10.4 $  $Date: 2014/04/10 21:33:41 $
...
if ~isempty(nonlcon) && isstruct(nonlcon) && nargin < 10
    options = nonlcon;
    nonlcon = [];
end

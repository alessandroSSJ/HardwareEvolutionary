function [x,fval,exitFlag,output,population,scores] = ga1(fun,nvars,Aineq,bineq,Aeq,beq,lb,ub,nonlcon,intcon,options)
...
if ~isempty(intcon)   
    ...
    switch (output.problemtype)
        case 'unconstrained'
            [x,fval,exitFlag,output,population,scores] = gaunc1(FitnessFcn,nvars, ...

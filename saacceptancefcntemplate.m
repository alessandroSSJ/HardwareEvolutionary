function acceptpoint = saacceptancefcntemplate(optimValues,newx,newfval)    
%SAACCEPTANCEFCNTEMPLATE Template to write custom Acceptance Function
%   ACCEPTPOINT = SAACCEPTANCEFCNTEMPLATE(optimValues,newx,newfval)

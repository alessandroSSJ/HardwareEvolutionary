function stop = gsplotbestf(optimValues, state)
%GSPLOTBESTF Plot best function value.
%
%   STOP = GSPLOTBESTF(OPTIMVALUES, STATE) plots OPTIMVALUES.BESTFVAL
...
switch state
    ...
    case 'iter'
        ...
        plotBest = findobj(get(gca,'Children'), 'Tag', 'gsplotbestf');
